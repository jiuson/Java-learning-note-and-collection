...
public class UtilsGraphics2D {
    ...
    private static final int HEIGHT = 300;//图片高度
    private static String message = "华图教育财务";
    ...
    public static BufferedImage startGraphics2D(){
        ...
        g.drawString("★", CENTERX-(120/2) + 10, CENTERY+(120/3));

        //添加姓名
        g.setFont(new Font("宋体", Font.LAYOUT_LEFT_TO_RIGHT, 30));// 写入签名
        g.drawString(centerName, CENTERX -(55), CENTERY +(30+50));
